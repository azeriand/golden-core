        ...
        <article className='flex flex-col items-center w-full gap-y-3'>
            ...
            <section className='flex justify-between w-full'>
                ...
                <div className="flex gap-x-2 justify-end">
                    ...
                    <Button appearance='mate' size='sm' color="purple" intensity={700} className="rounded-md mt-4 aspect-square" icon={<IoSettingsSharp size={14}/>}/>
                    <Button appearance="outlined" size='sm' color='amber' intensity={700} icon={<TbLogout size={14}/>} className="aspect-square" style={{ color: '#5A463A' }} onClick={logout}/>
                </div>
            </section>
